...
const NextJSInsightsPage = async () => {
  const technology = 'nextjs';
    ...
    <div className="container mx-auto px-4 py-12 bg-gray-900 text-white min-h-screen">
      ...
      {summary ? (
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-blue-300">Latest Next.js Summary</h2>
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
          <p className="text-gray-300">No summary available for Next.js.</p>
        </div>
      )}
    </div>
  );
...
export default NextJSInsightsPage;
